...
def main():
    INPUT_VIDEO = "assets/video/fpt.mp4"
    LABEL_FOLDER = "person.v1i.yolov8/train/labels"
    OUTPUT_COCO = "assets/video/fpt-output-coco.mp4"
    OUTPUT_YOLOV8M = "assets/video/fpt-output-yolov8m.mp4"
