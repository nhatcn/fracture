...
if __name__ == "__main__":
    ...
    # Đọc ground truth counting từ file (được tạo từ nhãn YOLO)
    # Giả sử bạn đã lưu gt_in_count và gt_out_count vào file (nếu không, bạn cần chạy compute_counting_ground_truth trước)
    gt_in_count = 50  # Thay bằng giá trị thực tế từ compute_counting_ground_truth
    gt_out_count = 30  # Thay bằng giá trị thực tế từ compute_counting_ground_truth
