...
INPUT_PATH = "assets/video/fpt-test.mp4"
OUTPUT_PATH = "assets/video/fpt-test-ouput-best12m,.mp4"

if __name__ == "__main__":
    # Chạy với YOLOv8m (best7.pt)
    obj = ObjectTracking(INPUT_PATH, OUTPUT_PATH, model_path="best_yolov8m_coco.pt")
    obj.process()

    # Chạy với YOLOv8m_ResBlock_CBAM
    obj_cbam = ObjectTracking(INPUT_PATH, "assets/video/fpt-test-output-cbam.mp4", model_path="best_of_v8.pt")
    obj_cbam.process()
