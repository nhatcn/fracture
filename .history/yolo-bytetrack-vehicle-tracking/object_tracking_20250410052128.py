...
# Định nghĩa ResBlock_CBAM (tạm thời giữ nguyên để load file mô hình)
...
# In các key của 'model' để kiểm tra chi tiết
...
class ObjectTracking:
    ...
    def callback(self, frame, index):
        ...
        # Chuyển lại từ xyxy sang xywh cho tracking
        tracking_xywh = []
        for box in detections.xyxy:
            x1, y1, x2, y2 = box
            w = x2 - x1
